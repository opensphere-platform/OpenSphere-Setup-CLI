...
export const REGISTRY_NAMESPACES=Object.freeze(['opensphere-console-data','opensphere-console-change','opensphere-monitoring','opensphere-console','opensphere-system','opensphere-shell-sessions','opensphere-foundation']);
